      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-4xl">
          <div className="bg-amber-500 rounded-sm p-8 md:p-12 text-center">
            ...
            <a
              href="tel:7022221964"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-stone-950 text-amber-400 font-semibold rounded-sm hover:bg-stone-900 transition-colors"
            >
